class PostCategoriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_categories_path, status: :see_other, notice: "Post category was successfully destroyed." }
  ...
  private
    ...
    def set_post_category
      @post_category = PostCategory.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def post_category_params
      params.expect(post_category: [ :post_id, :category_id ])
    end
end
