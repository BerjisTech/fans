class SubscriptionPlansController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to subscription_plans_path, status: :see_other, notice: "Subscription plan was successfully destroyed." }
  ...
  private
    ...
    def subscription_plan_params
      params.expect(subscription_plan: [ :user_id, :title, :description, :price, :billing_frequency, :is_active ])
    end
end
