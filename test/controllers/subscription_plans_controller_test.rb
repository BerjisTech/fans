...
class SubscriptionPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription_plan" do
    assert_difference("SubscriptionPlan.count") do
      post subscription_plans_url, params: { subscription_plan: { billing_frequency: @subscription_plan.billing_frequency, description: @subscription_plan.description, is_active: @subscription_plan.is_active, price: @subscription_plan.price, title: @subscription_plan.title, user_id: @subscription_plan.user_id } }
    end
  ...
  test "should update subscription_plan" do
    patch subscription_plan_url(@subscription_plan), params: { subscription_plan: { billing_frequency: @subscription_plan.billing_frequency, description: @subscription_plan.description, is_active: @subscription_plan.is_active, price: @subscription_plan.price, title: @subscription_plan.title, user_id: @subscription_plan.user_id } }
