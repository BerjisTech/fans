...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "should create subscription" do
    ...
    fill_in "Subscription plan", with: @subscription.subscription_plan_id
  ...
  test "should update Subscription" do
    ...
    fill_in "End date", with: @subscription.end_date.to_s
    fill_in "Start date", with: @subscription.start_date.to_s
    fill_in "Status", with: @subscription.status
    fill_in "Subscription plan", with: @subscription.subscription_plan_id
    fill_in "User", with: @subscription.user_id
